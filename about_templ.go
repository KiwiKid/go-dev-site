...
func aboutPage() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		_, err = templBuffer.WriteString("<img src=\"/img/atopthehill.jpg\" alt=\"Myself on the top of a hill after climbing 1.4 vertical km to retrieve a fallen drone...\" width=\"5184\" height=\"3880\"></div></div></div>")
		if err != nil {
			return err
		}
		if !templIsBuffer {
